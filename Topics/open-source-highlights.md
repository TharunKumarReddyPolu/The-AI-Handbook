...
> Repos worth starring — real code you can run, fork, and contribute to. These are the open-source projects shaping the AI ecosystem.
...
| **[Context7](https://github.com/upstash/context7)** | Up-to-date docs for LLMs via MCP | ![Stars](https://img.shields.io/github/stars/upstash/context7?style=social) |
...
| **[Dify](https://github.com/langgenius/dify)** | Open-source LLM app development platform | ![Stars](https://img.shields.io/github/stars/langgenius/dify?style=social) |
| **[n8n](https://github.com/n8n-io/n8n)** | Open-source workflow automation with AI | ![Stars](https://img.shields.io/github/stars/n8n-io/n8n?style=social) |
| **[LangChain](https://github.com/langchain-ai/langchain)** | Framework for building LLM-powered apps | ![Stars](https://img.shields.io/github/stars/langchain-ai/langchain?style=social) |
| **[ComfyUI](https://github.com/comfyanonymous/ComfyUI)** | Node-based Stable Diffusion workflow engine | ![Stars](https://img.shields.io/github/stars/comfyanonymous/ComfyUI?style=social) |
| **[RAGFlow](https://github.com/infiniflow/ragflow)** | Enterprise RAG engine for document understanding | ![Stars](https://img.shields.io/github/stars/infiniflow/ragflow?style=social) |

---

## 💡 Pro Tips

- **Ollama + llama.cpp** are the backbone of the local AI movement — Ollama wraps llama.cpp with a friendly CLI
- **Dify** is the most complete open-source platform for building LLM apps with RAG, agents, and model management
- **n8n** has evolved from a workflow tool to a powerful AI agent builder
- Fork and contribute to these repos — the AI open-source community is one of the most active on GitHub
